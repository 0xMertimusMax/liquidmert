...
#[derive(Debug)]
pub struct WhaleWatcherProcessor {
    verbose: bool,
    processed_count: usize,
}

impl WhaleWatcherProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting WhaleWatcher processing");
    
    let mut processor = WhaleWatcherProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = WhaleWatcherProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = WhaleWatcherProcessor::new(false);
